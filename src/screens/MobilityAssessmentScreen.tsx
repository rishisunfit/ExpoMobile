  ...
  return (
    <ScrollView contentContainerStyle={{ paddingBottom: 32, backgroundColor: COLORS.background.secondary }}>
        ...
        <View style={styles.imagesSection}>
          {imageUrls.map((url, idx) => (
            <Image
              ...
              source={{ uri: url }}
              style={styles.image}
              onError={e => console.log('Image failed to load:', url, e.nativeEvent)}
            />
          ))}
        </View>
      )}
      ...
      <View style={styles.assessmentSection}>
        ...
        {/* Fill-in Questions */}
        <View style={styles.card}>
          <Text style={styles.cardTitle}>What's your main fitness goal this week?</Text>
          <TextInput
        ...
        <View style={styles.card}>
          <Text style={styles.cardTitle}>How many hours did you sleep last night?</Text>
          <TextInput

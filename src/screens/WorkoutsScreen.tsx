...
const MyCalendar = ({
  clientId,
  navigation,
}: MyCalendarProps & { navigation: any }) => {
  ...
  useEffect(() => {
    const loadSchedule = async () => {
      ...
      const { data, error } = await supabase.rpc<any, ScheduleRow[]>(
        "get_client_schedule",
        {
          client: clientId,
          start,
    ...
    <View style={styles.section}>
      <View style={styles.sectionHeader}>
        ...
        <TouchableOpacity>
          <Text
            style={styles.link}
            onPress={() => navigation.navigate("ReorderScreen")}
          >
            Full View
          </Text>
        </TouchableOpacity>
      ...
      <Card style={styles.calendarCard}>
        <View style={styles.calendarHeader}>
          <Typography.Body style={styles.calendarMonth}>
        ...
        <View style={{ flexDirection: "row", justifyContent: "center" }}>
          {["S", "M", "T", "W", "T", "F", "S"].map((d, i) => (
            <Text key={`${d}-${i}`} style={styles.calendarDayHeader}>
              {d}
            </Text>
          ))}
        </View>
        ...
        <View style={styles.calendarScheduleSection}>
          <View style={styles.sectionHeaderRow}>
            <Typography.Body style={styles.calendarScheduleTitle}>
...
export default function WorkoutsScreen({ navigation }: any) {
  ...
  const [mobilityFavorites, setMobilityFavorites] = useState<
    Database["public"]["Tables"]["mobility_videos"]["Row"][]
  >([]);
    ...
    >
      <View style={styles.container}>
        ...
        >
          ...
          <View style={styles.section}>
            ...
            <Card style={styles.sessionCard}>
              <View style={styles.sessionImageWrapper}>
                <Image
                  source={{
                    uri: "https://storage.googleapis.com/uxpilot-auth.appspot.com/f87bb8eb54-5dacafe011510304ef67.png",
                  }}
              ...
              <View style={styles.sessionContent}>
                <View style={styles.sessionTitleRow}>
                  <View>
                    <Typography.H2 style={styles.sessionTitle}>
                      {workoutName}
                    </Typography.H2>
                    <Typography.Subtext>
          ...
          {/* My Calendar */}
          {clientId && (
            <MyCalendar clientId={clientId} navigation={navigation} />
          )}

          {/* Ask Meadow */}
          <View style={styles.section}>
            <Typography.H2 style={{ marginBottom: 16 }}>
              Ask Meadow
            </Typography.H2>
            <Card style={styles.askMeadowCard}>
              <View style={styles.askMeadowRow}>
                ...
                <View style={{ flex: 1 }}>
                  <Typography.H2 style={styles.askMeadowTitle}>
                    Your AI Coach
                  </Typography.H2>
                  <Typography.Subtext>
                    Ask questions about your training, nutrition, or recovery
                  </Typography.Subtext>
                </View>
              </View>
                ...
                <Card key={item.title} style={styles.videoCard}>
                  <View style={styles.videoCardRow}>
                    ...
                    <View style={styles.videoCardContent}>
                      <Typography.Body style={styles.videoCardTitle}>
                        {item.title}
                      </Typography.Body>
                      <Typography.Subtext style={styles.videoCardDesc}>
                        {item.desc}
                      </Typography.Subtext>
                      <View style={styles.videoCardMetaRow}>
                        <Text
                          style={[
                            styles.videoCardLevel,
                            {
                              backgroundColor: item.levelColor,
                              color: item.levelTextColor,
                            },
                          ]}
                        >
                          {item.level}
                        </Text>
                        <Text style={styles.videoCardRating}>
                          {item.rating} ⭐
                        </Text>
                      </View>
                    </View>
          ...
          <View style={styles.section}>
            <View style={styles.sectionHeader}>
              ...
              <TouchableOpacity
                onPress={() => navigation.navigate("VideoMobilityScreen")}
              >
                <Text style={styles.link}>See All</Text>
              </TouchableOpacity>
            </View>
...
const REMOTE_PLACEHOLDER =
  "https://via.placeholder.com/96x80.png?text=No+Image";

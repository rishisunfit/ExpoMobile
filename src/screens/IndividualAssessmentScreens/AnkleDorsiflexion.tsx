...
export default function AnkleDorsiflexion() {
        ...
        >
          <View style={{ alignItems: 'center' }}>
            <View style={styles.gradientHeaderIconCircle}>
              <Icon name="1" size={28} color="#fff" />
            </View>
            <Text style={styles.gradientHeaderTitle}>Ankle Dorsiflexion</Text>
            <Text style={styles.gradientHeaderSubtitle}>Assess your ankle flexibility and range of motion</Text>
          </View>
        </LinearGradient>

        <View style={{ paddingHorizontal: 16, gap: 24 }}>
          {/* Watch Ankle Assessment Guide */}
          <View style={styles.card}>
            <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 16 }}>
              <View style={styles.iconCircleAccent}>
                <Icon name="play" size={16} color={COLORS.success} />
              </View>
              <Text style={styles.cardTitle}>Watch Ankle Assessment Guide</Text>
            </View>
            <View style={styles.videoContainer}>
              <View style={styles.videoGradient}>
                <View style={{ alignItems: 'center' }}>
                  ...
                  <Text style={styles.videoLabel}>Ankle Mobility Assessment</Text>
                  <Text style={styles.videoDuration}>3:24 minutes</Text>
                </View>
              </View>
            </View>
            {/* Steps */}
            <View style={{ gap: 16 }}>
              {[
                {
                  title: 'Start In A Half-Kneeling Position',
                },
                {
                  title: 'Drive Knee Over The Toes',
                },
                {
                  title: 'Use Test Cues And Switch Sides',
                },
              ].map((step, idx) => (
                <View key={step.title} style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 0 }}>
                  <View style={[styles.stepCircle, { marginTop: 0, marginBottom: 0 }] }>
          ...
          <View style={styles.card}>
            ...
            <View style={styles.privacyBox}>
              <Icon name="shield-check" size={16} color={COLORS.success} style={{ marginRight: 8, marginTop: 2 }} />
              <View style={{ flex: 1 }}>
          ...
          <View style={styles.card}>
            ...
            <View style={{ marginBottom: 20 }}>
              <Text style={styles.questionLabel}>Rate your ankle stiffness (1-10)</Text>
              <View style={{ alignItems: 'center', marginTop: 8 }}>
                <Text style={{ fontSize: 18, fontWeight: '600', color: COLORS.primary, marginBottom: 4 }}>{stiffness}</Text>
                <Slider
              ...
              {[
                ...
                >
                  <View style={[
                    ...
                    {pain === opt.value && <View style={styles.radioInner} />}
                  </View>
          ...
          {/* Submit Button */}
          <TouchableOpacity style={styles.submitBtn} onPress={() => navigation.navigate('HipInternalRotation')}>
